...
class BookHistoriesControllerTest < ActionController::TestCase
  ...
  test "should create book_history" do
    assert_difference('BookHistory.count') do
      post :create, book_history: { book_id: @book_history.book_id, chk_in_date: @book_history.chk_in_date, chk_out_dt: @book_history.chk_out_dt, user_id: @book_history.user_id }
    end
